...
setuptools.setup(
    name="smartdata",
    version="2012.11",
    description="Client library for Smart Data Project",
    long_description=read('README.rst'),
    url='https://github.com/mfaraji/smartdata.git',
    license='Apache',
    author='Mohammad Faraji',
    author_email='ms.faraji@utoronto.ca',
    classifiers=[
    ...
    entry_points={
        'console_scripts': ['sd66 = smartdata.shell:main']
    }
)
